<main class="py-16">
    <article class="prose dark:prose-invert">
        ...
        <p class="lead">Use the Protocol API to access contacts, conversations, group messages, and more and
            seamlessly integrate your product into the workflows of dozens of devoted Protocol users.
        </p>
        <div class="not-prose mb-16 mt-6 flex gap-3">
            ...
            <a
                ...
                href="/sdks">Explore SDKs</a>
        </div>
        <h2 class="scroll-mt-24">Getting started</h2>
        <p class="lead">To get started, create a new application in your <a href="/#">developer
            settings</a>, then read about how to make requests for the resources you need to access
            using our HTTP APIs or dedicated client SDKs. When your integration is ready to go live, publish
            it to our <a href="/#">integrations directory</a> to reach the Protocol community.
        </p>
        <div class="not-prose">
            <a
        ...
        <div class="my-16 xl:max-w-none">
            <h2 id="guides" class="scroll-mt-24"><a
                class="group text-inherit no-underline hover:text-inherit" href="/#guides">Guides</a>
            </h2>
            <div
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-zinc-600 dark:text-zinc-400">Learn how to programmatically
                        configure webhooks for your app.
                    </p>
                    <p class="mt-4">
                        <a
                            class="inline-flex gap-0.5 justify-center overflow-hidden text-sm font-medium transition text-emerald-500 hover:text-emerald-600 dark:text-emerald-400 dark:hover:text-emerald-500"
                ...
                <div
                    ...
                    <div class="pointer-events-none">
                        ...
                        <div class="absolute inset-0 rounded-2xl opacity-0 mix-blend-overlay transition duration-300 group-hover:opacity-100"
                            ...
                            <svg aria-hidden="true"
                                ...
                                <rect width="100%" height="100%" stroke-width="0" fill="url(#:R1d6hd6:)">
                                </rect>
                                <svg x="50%" y="16" class="overflow-visible">
                                    <rect stroke-width="0" width="73" height="57" x="0" y="56"></rect>
                                    <rect stroke-width="0" width="73" height="57" x="72" y="168"></rect>
                    ...
                    <div class="relative rounded-2xl px-4 pt-16 pb-4">
                        ...
                        <p class="mt-1 text-sm text-zinc-600 dark:text-zinc-400">Learn about the contact
                            model and how to create, retrieve, update, delete, and list contacts.
                        </p>
                    </div>
                </div>
                <div
                    ...
                    <div class="pointer-events-none">
                        ...
                        <div class="absolute inset-0 rounded-2xl opacity-0 mix-blend-overlay transition duration-300 group-hover:opacity-100"
                            ...
                            <svg aria-hidden="true"
                                ...
                                <rect width="100%" height="100%" stroke-width="0" fill="url(#:R1dahd6:)">
                                </rect>
                                <svg x="50%" y="-6" class="overflow-visible">
                                    <rect stroke-width="0" width="73" height="57" x="-72" y="112"></rect>
                                    <rect stroke-width="0" width="73" height="57" x="72" y="168"></rect>
                ...
                <div
                    ...
                    <div class="pointer-events-none">
                        ...
                        <div class="absolute inset-0 rounded-2xl opacity-0 mix-blend-overlay transition duration-300 group-hover:opacity-100"
                            ...
                            <svg aria-hidden="true"
                                ...
                                <rect width="100%" height="100%" stroke-width="0" fill="url(#:R1dehd6:)">
                                </rect>
                                <svg x="50%" y="32" class="overflow-visible">
                                    <rect stroke-width="0" width="73" height="57" x="0" y="112"></rect>
                                    <rect stroke-width="0" width="73" height="57" x="72" y="224"></rect>
                    ...
                    <div class="relative rounded-2xl px-4 pt-16 pb-4">
                        ...
                        <p class="mt-1 text-sm text-zinc-600 dark:text-zinc-400">Learn about the message
                            model and how to create, retrieve, update, delete, and list messages.
                        </p>
                    </div>
                </div>
                <div
                    ...
                    <div class="pointer-events-none">
                        ...
                        <div class="absolute inset-0 rounded-2xl opacity-0 mix-blend-overlay transition duration-300 group-hover:opacity-100"
                            ...
                            <svg aria-hidden="true"
                                ...
                                <rect width="100%" height="100%" stroke-width="0" fill="url(#:R1dihd6:)">
                                </rect>
                                <svg x="50%" y="22" class="overflow-visible">
                                    <rect stroke-width="0" width="73" height="57" x="0" y="56"></rect>
                                </svg>
                    ...
                    <div class="relative rounded-2xl px-4 pt-16 pb-4">
                        ...
                        <h3 class="mt-4 text-sm font-semibold leading-7 text-zinc-900 dark:text-white"><a
                            href="/groups"><span class="absolute inset-0 rounded-2xl"></span>Groups</a>
                        </h3>
                        <p class="mt-1 text-sm text-zinc-600 dark:text-zinc-400">Learn about the group model
                            and how to create, retrieve, update, delete, and list groups.
                        </p>
                    </div>
                </div>
            </div>
